...
var getSU = function(userName){
	username = encodeURIComponent(userName);
	return sinaSSOEncoder.base64.encode(username); // su是username的别名
}
var getSP = function(rsaPubkey,servertime,nonce,password){
	var RSAKey = new sinaSSOEncoder.RSAKey();
	RSAKey.setPublic(rsaPubkey, '10001');
	return password = RSAKey.encrypt([servertime, nonce].join("\t") + "\n" + password);
}
