/* UriUniqFilterImpl
*
* $Id: SetBasedUriUniqFilter.java 4036 2005-12-16 03:10:54Z gojomo $
*
...
public abstract class SetBasedUriUniqFilter implements UriUniqFilter {
    private static Logger LOGGER = LoggerFactory.getLogger(SetBasedUriUniqFilter.class.getName());
...
//    public void add(String key, Request value) {
//        profileLog(key);
//        if (setAdd(key)) {
...
//    }
    ...
    public boolean add(String key) {
        ...
        if (setAdd(key)) {
            if (setCount() % 50000 == 0) {
                LOGGER.info("count: " + setCount() + " totalDups: " + duplicateCount);
            }
            return true;
        } else {
            duplicateCount++;
...
//    public void addNow(String key, Request value) {
//        add(key, value);
//    }
...
//    public void addForce(String key, Request value) {
//        profileLog(key);
//        setAdd(key);
//        this.receiver.receive(value);
//    }
    
    public void addForce(String key) {
        profileLog(key);
        setAdd(key);
    }
    ...
    public void forget(String key, Request value) {
        setRemove(key);
    }
