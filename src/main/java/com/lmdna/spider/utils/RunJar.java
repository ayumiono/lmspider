...
public class RunJar {
  ...
  public static void main(String[] args) throws Throwable {
    ...
    String taskFileParseClass = null;
    JarFile jarFile;
    try {
    ...
    if (manifest != null) {
      ...
      taskFileParseClass = manifest.getMainAttributes().getValue("Spider-TaskFile-Parser");
    }
    jarFile.close();
    ...
    spiderClass = spiderClass.replaceAll("/", ".");
    taskFileParseClass = spiderClass.replaceAll("/", ".");
    ...
    Class<?> mainClass = Class.forName(spiderClass, true, loader);
  ...
  public static void DifferentClassLoaderTest(){
	  System.out.println("different classloader test success");
  }
